...
Input: test_auth_token_expiry / AssertionError / tests/test_auth.py
  ...
  → output: { "action": "revert", "confidence": "high", "confidence_score": 0.90,
              "recommendation": "Revert — 2 prior failures (f-seed-01, f-seed-02) confirm JWT middleware regression.",
              "historical_matches": 2 }
```
